      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-14">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-gray-700 mb-5 leading-relaxed">
            At Dr Meenu’s Clinic, we believe every individual and couple deserves
            a chance to experience the joy of parenthood. With over 18 years of
            experience in gynecology and fertility care, we bring together
            compassion, cutting-edge technology, and personalized treatment
          ...
          <p className="text-gray-700 mb-8 leading-relaxed">
            ...
            looking for guidance, support, and effective fertility solutions,
            we are here for you. Let us walk this journey together.
          </p>
